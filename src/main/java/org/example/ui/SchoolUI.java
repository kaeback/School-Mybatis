...
import org.example.manager.SchoolManager;
		...
		if (input > 0 && input < 4) {
			...
			try {
				...
				case 1:
					...
					p = manager.addPerson(new Student(name, ssn, age, "STUDENT", stdNo));
					break;
				case 2:
					System.out.print("전공: ");
					String major = scanner.next();
					
					p = manager.addPerson(new Teacher(name, ssn, age, "TEACHER", major));
					break;
				case 3:
					System.out.print("부서: ");
					String dept = scanner.next();
					
					p = manager.addPerson(new Staff(name, ssn, age, "STAFF", dept));
					break;
				default: System.out.println("다시 입력해 주세요");
				}
